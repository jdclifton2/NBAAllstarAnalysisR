...
# treeTrain = sample(dim(cleanDF)[1], dim(cleanDF)[1]*0.7)
# treeTest = nonCorDF[-treeTrain, ]
# wasMvpTest = cleanDF[treeTrain,'was_mvp']
...
# was_mvp ~ VORP + WS * WS.48 * OWS + BPM + PER + PTS * FG. + AST + TRB + BLK + STL + TOV + GS
