...
mvpForest <- randomForest(was_mvp ~ ., data = treeTrain)
mvpForest

predTrain <- predict(mvpForest, treeTest, type = "class")
acc = table(predTrain, treeTest$was_mvp)
acc
